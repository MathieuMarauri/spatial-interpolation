...
<script>
  $(document).ready(function() {
    $('#TOC').parent().prepend('<div id="nav_logo"><img src="images/gold-unsplash.jpg"></div>');
  });
</script>
...
The exponential semi-variogram has the lowest RMSE. Remember that it also had the lowest loss value.
