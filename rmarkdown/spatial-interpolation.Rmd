...
$$
We want the parameters $\gamma_0, \sigma, \phi$ that minimise the loss. There are simply obtained with the `optim()` function. Here we specify a spherical model.
...
=
\begin{bmatrix}
0 & \cdots & \gamma(s_1,s_n) &1 \\
\vdots & \ddots & \vdots  & \vdots \\
\gamma(s_n,s_1) & \cdots & 0 & 1 \\
1 &\cdots& 1 & 0 
\end{bmatrix}^{-1}
...
Let's check that indeed both solution produce the same output.
