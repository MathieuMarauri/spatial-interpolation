...
Kriging is another method used to perform spatial interpolation. Unlike the previous one it is a stochastic one. A confidence interval is also computed with the prediction. 
...
Therefore for all $s$, $s'$ 2 points in $R$ and $h$ a translation we have:
...
Strict stationarity does not imply second-order stationarity as the first 2 moments may not be defined. And of course weak stationary does not imply strict stationarity.  
