...
The random field $Z_s$ can be divided into a constant term and a random one.

$$
Z_s = \mu + \delta_s
$$

The mean of the random field is quasi-constant, it is constant on the Kriging neighbourhood 
